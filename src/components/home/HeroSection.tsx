...
export function HeroSection() {
  return (
    <section className="w-screen bg-white lg:min-h-[calc(100vh-4.5rem)]">
      <div className="grid min-h-0 w-full grid-cols-1 items-stretch gap-10 lg:min-h-[calc(100vh-4.5rem)] lg:grid-cols-[53%_47%] lg:gap-0">
        {/* Left content column ~35% */}
        <div className="flex flex-col justify-center px-6 py-10 sm:px-8 sm:py-12 lg:py-14 lg:pr-8 lg:pl-[max(1.5rem,4vw)] xl:pl-[max(2rem,5vw)]">
          <div className="flex flex-col gap-5">
            <h1 className="heading-font text-[12rem] font-bold uppercase leading-[1] tracking-[0.02em] text-black sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl 2xl:text-7xl">
              <span className="block">Together</span>
              <span className="block">We</span>
              <span className="block">Climb</span>
            </h1>
            <p className="max-w-sm text-base leading-relaxed text-black/75 sm:text-lg sm:leading-[1.6] lg:text-[1.25rem] xl:text-[1.4375rem]">
            ...
            <p className="mt-2 text-[11px] font-semibold uppercase tracking-[0.3em] text-black/60">
              {BRAND_MOTTO}
            </p>
          </div>
        </div>
